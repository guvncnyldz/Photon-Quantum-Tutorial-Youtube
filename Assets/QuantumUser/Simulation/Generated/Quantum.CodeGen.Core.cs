...
namespace Quantum {
  ...
  public unsafe partial struct Input {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 19249;
        hash = hash * 31 + LeftClick.GetHashCode();
    ...
    public Boolean IsDown(InputButtons button) {
      switch (button) {
        case InputButtons.LeftClick: return LeftClick.IsDown;
        default: return false;
      }
    }
    public Boolean WasPressed(InputButtons button) {
      switch (button) {
        case InputButtons.LeftClick: return LeftClick.WasPressed;
        default: return false;
      }
    }
    static partial void SerializeCodeGen(void* ptr, FrameSerializer serializer) {
        var p = (Input*)ptr;
        Button.Serialize(&p->LeftClick, serializer);
  ...
  public unsafe partial struct Character : Quantum.IComponent {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        ...
        hash = hash * 31 + GoldCount.GetHashCode();
        hash = hash * 31 + SpawnerSpec.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        ...
        AssetRef.Serialize(&p->SpawnerSpec, serializer);
        FP.Serialize(&p->GoldCount, serializer);
        FP.Serialize(&p->Health, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct Gold : Quantum.IComponent {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct GoldSpawner : Quantum.IComponentSingleton {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 15377;
        hash = hash * 31 + CurrentGoldCount.GetHashCode();
        hash = hash * 31 + MaxGoldCount.GetHashCode();
        hash = hash * 31 + GoldPrototype.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (GoldSpawner*)ptr;
        AssetRef.Serialize(&p->GoldPrototype, serializer);
        FP.Serialize(&p->CurrentGoldCount, serializer);
        FP.Serialize(&p->MaxGoldCount, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct MovementController : Quantum.IComponent {
    ...
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 17783;
        hash = hash * 31 + Hit3D.GetHashCode();
        hash = hash * 31 + IsPathSucceeded.GetHashCode();
        return hash;
      }
    }
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (MovementController*)ptr;
        QBoolean.Serialize(&p->IsPathSucceeded, serializer);
        Hit3D.Serialize(&p->Hit3D, serializer);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct SpawnerController : Quantum.IComponent {
    public const Int32 SIZE = 16;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
    public AssetRef<SpawnerSpec> SpawnerSpec;
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (SpawnerController*)ptr;
        PlayerRef.Serialize(&p->PlayerRef, serializer);
        AssetRef.Serialize(&p->SpawnerSpec, serializer);
    }
  }
  public unsafe partial interface ISignalOnTriggerGoldWithCharacter : ISignal {
    void OnTriggerGoldWithCharacter(Frame f, EntityRef gold, Character* character);
  }
  public static unsafe partial class Constants {
  }
  public unsafe partial class Frame {
    private ISignalOnTriggerGoldWithCharacter[] _ISignalOnTriggerGoldWithCharacterSystems;
    ...
    partial void InitGen() {
      ...
      _ISignalOnTriggerGoldWithCharacterSystems = BuildSignalsArray<ISignalOnTriggerGoldWithCharacter>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.Gold>();
      BuildSignalsArrayOnComponentRemoved<Quantum.Gold>();
      BuildSignalsArrayOnComponentAdded<Quantum.GoldSpawner>();
      BuildSignalsArrayOnComponentRemoved<Quantum.GoldSpawner>();
      BuildSignalsArrayOnComponentAdded<MapEntityLink>();
      BuildSignalsArrayOnComponentRemoved<MapEntityLink>();
      BuildSignalsArrayOnComponentAdded<Quantum.MovementController>();
      BuildSignalsArrayOnComponentRemoved<Quantum.MovementController>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.SpawnerController>();
      BuildSignalsArrayOnComponentRemoved<Quantum.SpawnerController>();
    ...
    partial void SetPlayerInputCodeGen(PlayerRef player, Input input) {
      ...
      i->LeftClick = i->LeftClick.Update(this.Number, input.LeftClick);
      i->Origin = input.Origin;
    ...
    public unsafe partial struct FrameSignals {
      public void OnTriggerGoldWithCharacter(EntityRef gold, Character* character) {
        var array = _f._ISignalOnTriggerGoldWithCharacterSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnTriggerGoldWithCharacter(_f, gold, character);
          }
        }
      }
    }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.Gold), Quantum.Gold.SIZE);
      typeRegistry.Register(typeof(Quantum.GoldSpawner), Quantum.GoldSpawner.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.MovementController), Quantum.MovementController.SIZE);
      ...
      typeRegistry.Register(typeof(Quantum.SpawnerController), Quantum.SpawnerController.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 5)
        ...
        .Add<Quantum.Gold>(Quantum.Gold.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.GoldSpawner>(Quantum.GoldSpawner.Serialize, null, null, ComponentFlags.Singleton)
        .Add<Quantum.MovementController>(Quantum.MovementController.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.SpawnerController>(Quantum.SpawnerController.Serialize, null, null, ComponentFlags.None)
        .Finish();
    }
    [Preserve()]
